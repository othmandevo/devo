...
class DevoStore {
    ...
    handleMobileBehaviors() {
        ...
        // Auto-close modals on orientation change
        if (width <= 768) {
            // Ensure proper touch scrolling
            const scrollableElements = document.querySelectorAll('.cart-items, .product-detail-overlay');
        ...
        if (width <= 480) {
            ...
            const touchTargets = document.querySelectorAll('.btn, .add-to-cart-btn, .filter-btn, .nav-link, .mobile-menu-toggle');
